...
public class MapsActivity3 extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driverlogout=(Button)findViewById(R.id.Logout);
        ...
        driverlogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(MapsActivity3.this,DriverActivity.class);
                startActivity(i);
        ...
        Share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(location!=null){
                   ...
                   ref=FirebaseDatabase.getInstance().getReference().child("Users").child("Riders").child(driverid);
                    ...
                    if(location!=null) {
                        mdata = FirebaseDatabase.getInstance().getReference();
                        mdata.child(x).child("lat").setValue(location.getLatitude());
                        mdata.child(x).child("lng").setValue(location.getLongitude());
                    }*/


                   mdata= FirebaseDatabase.getInstance().getReference().child(x).child(driverid).child("Location");
